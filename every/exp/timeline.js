...
let instructions1 = {
    ...
    wait_duration: 1000,
    choices: ['space'],
    stimulus: "<div style='margin: auto 0'><p>In this experiment, you will hear 3 tones, then you will hear a 4th.<br>Your task will be to identify if the fourth tone was part of the initial 3 tones.</div>",
