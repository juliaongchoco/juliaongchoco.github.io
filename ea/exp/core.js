...
let debrief_text =
    ...
    '<p>Age: <br><input name="age" type="number" style="width: 20%; background-color: black; border-radius: 4px; padding: 10px 10px; margin: 8px 0; border: 1px solid #ccc; font-size: 15px"/>' +
    ...
    '<p>Please indicate the number of years of musical training: <br><input name="musical_training" type="number" style="width: 20%; background-color: black; border-radius: 4px; padding: 10px 10px; margin: 8px 0; border: 1px solid #ccc; font-size: 15px"/>' +
    ...
    '<p>We know it is generally difficult to stay focused in these online experiments.  On a scale of 1-100 (with 1 being very distracted, and 100 being very focused), how well did you pay attention to the experiment?  (This will not affect whether you receive credit or compensation.) <br><input name="attn" type="number" max="100" style="background-color: black; width: 20%; border-radius: 4px; padding: 10px 10px; margin: 8px 0; border: 1px solid #ccc; font-size: 15px"></p></div>';
